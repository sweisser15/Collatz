...
FILES :=                              \
    ...
    TestCollatz.out                   \
    TestCollatz.py		      \
    cs330e-collatz-tests/sweisser-RunCollatz.in    \
    cs330e-collatz-tests/sweisser-RunCollatz.out   \
    cs330e-collatz-tests/sweisser-TestCollatz.out  \
    cs330e-collatz-tests/sweisser-TestCollatz.py   \
